...
function Registration(){
    ...
    const handleSubmit = async (e) => {
        ...
        console.log(details)
        if (details.type === "radio1") {
            history("/verifications");
          } else if (details.type === "radio2") {
            history("/verificationp");
        }
    }
    return(
            ...
            <form action=""  onSubmit={handleSubmit} >
               <div className="radios">
                   <button className="radiobtn">
                      <label htmlFor="">
                      <input type="radio" name="type" onChange={handleChange} value="radio1"/>
                      Etudiant 
                      </label>
                   </button>
                   <button className="radiobtn">
                      <label htmlFor="">
                      <input type="radio" name="type" onChange={handleChange} value="radio2"/>
                      Ensignant
                      </label>
                    </button >
                    <button className="radiobtn">
